...
public class HotelManager {
	 ...
	 */
	public void addRoom(Date sDate, Date eData, int price, Integer hotlId, Integer numberOfBeds, boolean wifi, boolean tv,
			boolean hotWater, boolean airConditioning) {
		rdb.addRoom(sDate, eData, price, hotlId, numberOfBeds, wifi, tv, hotWater, airConditioning);
	}
	
	/**
	 * @updates Room in Data Base.
	 */
	public void updateRoom(Integer room_id, Date sDate, Date eData, int price, Integer hotlId, Integer numberOfBeds, boolean wifi, boolean tv,
			boolean hotWater, boolean airConditioning) {
		rdb.updateRoom(room_id, sDate, eData, price, hotlId, numberOfBeds, wifi, tv, hotWater, airConditioning);
	}
